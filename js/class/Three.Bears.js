THREE.Bears = function (picture, id) {
	 ...
	 */
	//Head Accessory
	var headAccessory = new THREE.CubeGeometry(11, 11, 11);
	...
	//Head
	var head = new THREE.CubeGeometry(9, 9, 9);
	 ...
	 * Left / Right leg
	 */
	var arm = new THREE.CubeGeometry(6, 16, 6);
	for (var i = 0; i < 8; i += 1)
		arm.vertices[i].y -= 6;
	 ...
	 * BODY
	 */
	var body = new THREE.CubeGeometry(24, 12, 18);
