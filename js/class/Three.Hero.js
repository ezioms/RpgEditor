THREE.Hero = function (app) {
    ...
    person.name = 'hero';
    person.rotation.y = (90 * Math.PI / 180) + this.rotation.y;
    ...
    this.setPosition = function (x, y, z) {
        this.zone.set(x, y, z);
        yawObject.position.set(-(maxX / 2) + (x * sizeBloc + (sizeBloc / 2)), y * sizeBloc + (sizeBloc * 2), -(maxZ / 2) + (z * sizeBloc + (sizeBloc / 2)));
    };
    ...
    this.update = function (app) {
        ...
        var dirYx = Math.floor((clone.position.x + (maxX / 2)) / sizeBloc) + 1;
        var dirYy = Math.floor(clone.position.y / sizeBloc);
        var dirYz = Math.floor((clone.position.z + (maxZ / 2)) / sizeBloc) + 1;
        ...
        var dirXx = Math.floor(((clone.position.x + (clone.position.x > yawObject.position.x ? middle : -middle)) + (maxX / 2)) / sizeBloc) + 1;
        var dirXy = Math.floor(clone.position.y / sizeBloc);
        var dirXz = Math.floor((clone.position.z + (maxZ / 2)) / sizeBloc) + 1;
        ...
        var dirZx = Math.floor((clone.position.x + (maxX / 2)) / sizeBloc) + 1;
        var dirZy = Math.floor(clone.position.y / sizeBloc);
        var dirZz = Math.floor(((clone.position.z + (clone.position.z > yawObject.position.z ? middle : -middle)) + (maxZ / 2)) / sizeBloc) + 1;
        if (app.map.hasObstacle(dirZx, dirZy) || app.map.hasObstacle(dirZx, dirZy - 1, dirZz)) {
            clone.position.z = yawObject.position.z;
            speedTmp -= 0.2;
        }

        if (clone.position.x < -(maxX / 2) + sizeBloc / 2)
            clone.position.x = -(maxX / 2) + sizeBloc / 2;
        else if (clone.position.x > maxX / 2 - (sizeBloc / 2))
            clone.position.x = maxX / 2 - (sizeBloc / 2);

        if (clone.position.z < -(maxZ / 2) + sizeBloc / 2)
            clone.position.z = -(maxZ / 2) + sizeBloc / 2;
        else if (clone.position.z > maxZ / 2 - (sizeBloc / 2))
            clone.position.z = maxZ / 2 - (sizeBloc / 2);
        ...
        if (person.position.x != clone.position.x || person.position.y != clone.position.y - 50 || person.position.z != clone.position.z || person.rotation.y != (90 * Math.PI / 180) + yawObject.rotation.y) {
        ...
        var newZoneX = Math.floor((clone.position.x + (maxX / 2)) / sizeBloc) + 1;
        var newZoneY = Math.floor(clone.position.y / sizeBloc) - 1;
        var newZoneZ = Math.floor((clone.position.z + (maxZ / 2)) / sizeBloc) + 1;
        ...
        if (!noBot) {
            ...
            person.rotation.y = (90 * Math.PI / 180) + yawObject.rotation.y;
