THREE.Bot = function (app, dataBot) {
    ...
    this.person = new THREE.Person( 'bot', dataBot.img, dataBot.name);
    ...
    this.update = function (app) {
        ...
        if ((!this.leak && rayonSecurite) || this.fixe) {
            ...
            if (this.person.position.x != this.position.x || this.person.position.y != this.position.y - 50
                || this.person.position.z != this.position.z || this.person.rotation.y != newRotation)
