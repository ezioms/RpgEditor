...
THREE.Matrix4.prototype = {constructor: THREE.Matrix4, set: function (a, b, c, d, e, f, g, h, i, j, l, m, n, p, o, q) {
	...
	var c = a.elements, d = b.elements, e = this.elements, f = c[0], g = c[4], h = c[8], i = c[12], j = c[1], l = c[5], m = c[9], n = c[13], p = c[2], o = c[6], q = c[10], r = c[14], t = c[3], B = c[7], u = c[11], c = c[15], s = d[0], z = d[4], A = d[8], v = d[12], y = d[1], C = d[5], G = d[9], H = d[13], J = d[2], E = d[6], M = d[10], K = d[14], F = d[3], I = d[7], L = d[11], d = d[15];
	e[0] = f * s + g * y + h * J + i * F;
	e[4] = f * z + g * C + h * E + i * I;
	e[8] = f * A + g * G + h * M + i * L;
	...
	var a = this.elements, b = a[0], c = a[4], d = a[8], e = a[12], f = a[1], g = a[5], h = a[9], i = a[13], j = a[2], l = a[6], m = a[10], n = a[14], p = a[3], o = a[7], q = a[11], a = a[15];
	...
	var b = this.elements, c = a.elements, d = c[0], e = c[4], f = c[8], g = c[12], h = c[1], i = c[5], j = c[9], l = c[13], m = c[2], n = c[6], p = c[10], o = c[14], q = c[3], r = c[7], t = c[11], c = c[15];
	...
	var d = a.x, e = a.y, f = a.z, g = Math.sqrt(d * d + e * e + f * f), d = d / g, e = e / g, f = f / g, g = d * d, h = e * e, i = f * f, j = Math.cos(b), l = Math.sin(b), m = 1 - j, n = d * e * m, p = d * f * m, m = e * f * m, d = d * l, o = e * l, l = f * l, f = g + (1 - g) * j, g = n + l, e = p - o, n = n - l, h = h + (1 - h) * j, l = m + d, p = p + o, m = m - d, i = i + (1 - i) * j, j = c[0], d = c[1], o = c[2], q = c[3], r = c[4], t = c[5], B = c[6], u = c[7], s = c[8], z = c[9], A = c[10], v = c[11];
	c[0] = f * j + g * r + e * s;
	c[1] = f * d + g * t + e * z;
	c[2] = f * o + g * B + e * A;
	c[3] = f * q + g * u + e * v;
...
(function (a) {
	...
	var b = new a.Vector3, c = new a.Vector3, d = new a.Vector3, e = new a.Vector3, f = new a.Vector3, g = new a.Vector3, h = new a.Matrix4, i = function (a, b) {
		...
		if (i instanceof a.Particle) {
			...
			if (m > q)
				return j;
			var A, v, y = i.geometry, C = y.vertices, G, H, J;
			...
			for (A = y.faces.length; q < A; q++)
				if (o = y.faces[q], m = !0 === H ? G[o.materialIndex] : i.material, void 0 !== m && (J = m.side, e.sub(o.centroid, c), f = o.normal, m = d.dot(f), !(Math.abs(m) < M) && (v = f.dot(e) / m, !(0 > v) && (J === a.DoubleSide || (J === a.FrontSide ? 0 > m : 0 < m)))))
...
THREE.Rectangle = function () {
	...
	this.addRectangle = function (f) {
		!0 === h ? (h = !1, b = f.getLeft(), c = f.getTop(), d = f.getRight(), e = f.getBottom()) : (b = b < f.getLeft() ? b : f.getLeft(), c = c < f.getTop() ? c : f.getTop(), d = d > f.getRight() ? d : f.getRight(), e = e > f.getBottom() ? e : f.getBottom());
		a()
	};
				...
				if (!1 !== f.visible) {
					if (f instanceof THREE.Light)
						...
						if (!1 === f.frustumCulled || !0 === F.contains(f))
							e = a(), e.object = f, null !== f.renderDepth ? e.z = f.renderDepth : (J.copy(f.matrixWorld.getPosition()), M.multiplyVector3(J), e.z = J.z), H.objects.push(e)
					} else
		...
		for (m = H.objects.length; g < m; g++)
			if (ca = H.objects[g].object, Ga = ca.matrixWorld, j = 0, ca instanceof THREE.Mesh) {
				...
				for (O = fa.length; la < O; la++)
					i = b(), i.positionWorld.copy(fa[la]), Ga.multiplyVector3(i.positionWorld), i.positionScreen.copy(i.positionWorld), M.multiplyVector4(i.positionScreen), i.positionScreen.x /= i.positionScreen.w, i.positionScreen.y /= i.positionScreen.w, i.visible = i.positionScreen.z > ea && i.positionScreen.z < Q;
				fa = 0;
						...
						if (O instanceof THREE.Face3)
							if (W = l[O.a], V = l[O.b], Z = l[O.c], !0 === W.visible && !0 === V.visible && !0 === Z.visible)
								if (qa = 0 > (Z.positionScreen.x - W.positionScreen.x) * (V.positionScreen.y - W.positionScreen.y) - (Z.positionScreen.y - W.positionScreen.y) * (V.positionScreen.x - W.positionScreen.x), ia === THREE.DoubleSide || qa === (ia === THREE.FrontSide))
									p === q ? (na = new THREE.RenderableFace3, o.push(na), q++, p++, n = na) : n = o[p++], n.v1.copy(W), n.v2.copy(V), n.v3.copy(Z);
								else
									continue;
							else
								continue;
							...
							if (W = l[O.a], V = l[O.b], Z = l[O.c], na = l[O.d], !0 === W.visible && !0 === V.visible && !0 === Z.visible && !0 === na.visible)
								if (qa = 0 > (na.positionScreen.x - W.positionScreen.x) * (V.positionScreen.y - W.positionScreen.y) - (na.positionScreen.y - W.positionScreen.y) * (V.positionScreen.x - W.positionScreen.x) || 0 > (V.positionScreen.x - Z.positionScreen.x) * (na.positionScreen.y - Z.positionScreen.y) - (V.positionScreen.y - Z.positionScreen.y) * (na.positionScreen.x - Z.positionScreen.x), ia === THREE.DoubleSide || qa === (ia === THREE.FrontSide)) {
									if (r === B) {
...
THREE.Geometry.prototype = {constructor: THREE.Geometry, applyMatrix: function (a) {
	...
	for (c = this.vertices.length; b < c; b++)
		C[b] = new THREE.Vector3, G[b] = new THREE.Vector3;
	b = 0;
	...
	for (c = this.faces.length; b < c; b++) {
		...
		for (d = 0; d < f.vertexNormals.length; d++)
			K.copy(f.vertexNormals[d]), e = f[F[d]], y = C[e], E.copy(y), E.subSelf(K.multiplyScalar(K.dot(y))).normalize(), M.cross(f.vertexNormals[d], y), e = M.dot(G[e]), e = 0 > e ? -1 : 1, f.vertexTangents[d] = new THREE.Vector4(E.x, E.y, E.z, e)
	}
	this.hasTangents = !0
	...
	if (0 < this.vertices.length) {
		...
		for (var b = this.boundingBox.min, c = this.boundingBox.max, d = 1, e = this.vertices.length; d < e; d++)
			(a = this.vertices[d], a.x < b.x ? b.x = a.x : a.x > c.x && (c.x = a.x), a.y < b.y ? b.y = a.y : a.y > c.y && (c.y = a.y), a.z < b.z) ? b.z = a.z : a.z > c.z && (c.z = a.z)
	} else
...
THREE.BufferGeometry.prototype = {constructor: THREE.BufferGeometry, applyMatrix: function (a) {
	...
	this.boundingBox || (this.boundingBox = {min: new THREE.Vector3(Infinity, Infinity, Infinity), max: new THREE.Vector3(-Infinity, -Infinity, -Infinity)});
	...
	if (this.attributes.position && this.attributes.index) {
		...
		var e = this.offsets, f = this.attributes.index.array, g = this.attributes.position.array, h = this.attributes.normal.array, i, j, l, m, n, p, o = new THREE.Vector3, q = new THREE.Vector3, r = new THREE.Vector3, t = new THREE.Vector3, B = new THREE.Vector3;
		c = 0;
		for (d = e.length; c < d; ++c) {
			...
			a = b;
			for (b += i; a < b; a += 3)
				i = u + f[a], j = u + f[a + 1], l = u + f[a + 2], m = g[3 * i], n = g[3 * i + 1], p = g[3 * i + 2], o.set(m, n, p), m = g[3 * j], n = g[3 * j + 1], p = g[3 * j + 2], q.set(m, n, p), m = g[3 * l], n = g[3 * l + 1], p = g[3 * l + 2], r.set(m, n, p), t.sub(r, q), B.sub(o, q), t.crossSelf(B), h[3 * i] += t.x, h[3 * i + 1] += t.y, h[3 * i + 2] += t.z, h[3 * j] += t.x, h[3 * j + 1] += t.y, h[3 * j + 2] += t.z, h[3 * l] += t.x, h[3 * l + 1] += t.y, h[3 * l + 2] += t.z
		}
		a = 0;
	...
	if (void 0 === this.attributes.index || void 0 === this.attributes.position || void 0 === this.attributes.normal || void 0 === this.attributes.uv)
		...
		for (J = F.length; H < J; ++H) {
			...
			C = G;
			for (G += E; C < G; C += 3)
				E = I + b[C], M = I + b[C + 1], K = I + b[C + 2], l = c[3 * E], m = c[3 * E + 1], n = c[3 * E + 2], p = c[3 * M], o = c[3 * M + 1], q = c[3 * M + 2], r = c[3 * K], t = c[3 * K + 1], B = c[3 * K + 2], u = e[2 * E], s = e[2 * E + 1], z = e[2 * M], A = e[2 * M + 1], v = e[2 * K], y = e[2 * K + 1], p -= l, l = r - l, o -= m, m = t - m, q -= n, n = B - n, z -= u, u = v - u, A -= s, s = y - s, y = 1 / (z * s - u * A), f.set((s * p - A * l) * y, (s * o - A * m) * y, (s * q - A * n) * y), g.set((z * l - u * p) * y, (z * m - u * o) * y, (z * n - u * q) * y), i[E].addSelf(f), i[M].addSelf(f), i[K].addSelf(f), j[E].addSelf(g), j[M].addSelf(g), j[K].addSelf(g)
		}
...
THREE.Spline = function (a) {
	...
	this.getLength = function (a) {
		...
		for (a = 1; a < c; a++)
			b = a / c, d = this.getPoint(b), g.copy(d), i += g.distanceTo(f), f.copy(d), b *= this.points.length - 1, b = Math.floor(b), b != e && (h[b] = i, e = b);
		h[h.length] = i;
...
THREE.Loader.prototype = {constructor: THREE.Loader, crossOrigin: "anonymous", addStatusElement: function () {
	...
	function e(a, e, f, h, i, j, r) {
		...
		if (j && (f = {repeat: THREE.RepeatWrapping, mirror: THREE.MirroredRepeatWrapping}, void 0 !== f[j[0]] && (a[e].wrapS = f[j[0]]), void 0 !== f[j[1]]))
			a[e].wrapT = f[j[1]];
		r && (a[e].anisotropy = r);
		if (!t) {
	...
	var g = this, h = "MeshLambertMaterial", i = {color: 15658734, opacity: 1, map: null, lightMap: null, normalMap: null, bumpMap: null, wireframe: !1};
	if (a.shading) {
	...
	var e = function (b) {
		...
		function G(b, c, d) {
			for (var e, f, g, h, c = new Uint32Array(a, c, 3 * b), i = new Uint16Array(a, d, b), d = 0; d < b; d++)
				e = c[3 * d], f = c[3 * d + 1], g = c[3 * d + 2], h = i[d], M.faces.push(new THREE.Face3(e, f, g, null, null, h))
		}
		...
		function E(b, c, d, e) {
			for (var f, g, h, i, j, l, m, n, o, c = new Uint32Array(a, c, 4 * b), d = new Uint32Array(a, d, 4 * b), p = new Uint16Array(a, e, b), e = 0; e < b; e++) {
				...
				o = F[3 * o + 2];
				M.faces.push(new THREE.Face4(f, g, h, i, [new THREE.Vector3(F[3 * l], F[3 * l + 1], F[3 * l + 2]), new THREE.Vector3(q, r, m), new THREE.Vector3(s, t, n), new THREE.Vector3(u, v, o)], null, j))
			}
		}
		...
		u && (t = l + 4 * u * Uint32Array.BYTES_PER_ELEMENT, H(u, l, t + 4 * u * Uint32Array.BYTES_PER_ELEMENT), C(u, t));
...
THREE.JSONLoader.prototype.createModel = function (a, b, c) {
	...
	p = a.vertices;
	var s = a.normals, z = a.colors, A = 0;
	...
	for (i = u.length; c < i;) {
		...
		if (f)
			for (f = 0; f < A; f++)
				r = a.uvs[f], n = u[c++], B = r[2 * n], n = r[2 * n + 1], d.faceUvs[f][h] = new THREE.UV(B, n);
		if (g)
			for (f = 0; f < A; f++) {
				r = a.uvs[f];
				t = [];
				for (g = 0; g < j; g++)
					n = u[c++], B = r[2 * n], n = r[2 * n + 1], t[g] = new THREE.UV(B, n);
				d.faceVertexUvs[f][h] = t
			}
		m && (m = 3 * u[c++], g = new THREE.Vector3, g.x = s[m++], g.y = s[m++], g.z = s[m], q.normal = g);
		if (l)
			for (f = 0; f < j; f++)
				m = 3 * u[c++], g = new THREE.Vector3, g.x = s[m++], g.y = s[m++], g.z = s[m], q.vertexNormals.push(g);
		o && (l = u[c++], l = new THREE.Color(z[l]), q.color = l);
		if (p)
			for (f = 0; f < j; f++)
				l = u[c++], l = new THREE.Color(z[l]), q.vertexColors.push(l);
		d.faces.push(q)
	}
	if (a.skinWeights) {
		c = 0;
...
THREE.GeometryLoader.prototype = {constructor: THREE.GeometryLoader, load: function (a) {
	...
	for (p = g.length; m < p;) {
		...
		if (q)
			for (f = 0; f < z; f++)
				o = g[m++], r.vertexColors.push(new THREE.Color(j[o]));
		d.faces.push(r)
	}
	if (a.skinWeights) {
		f = 0;
...
THREE.SceneLoader.prototype.parse = function (a, b, c) {
	...
	for (q in L.textures) {
		...
		if (l.url instanceof Array) {
			...
			H = a(1);
			J = J ? THREE.ImageUtils.loadCompressedTexture(o, l.mapping, H) : THREE.ImageUtils.loadTexture(o, l.mapping, H);
...
THREE.CanvasRenderer = function (a) {
	...
	var a = a || {}, f = this, g, h, i, j = new THREE.Projector, l = void 0 !== a.canvas ? a.canvas : document.createElement("canvas"), m, n, p, o, q = l.getContext("2d"), r = new THREE.Color(0), t = 0, B = 1, u = 0, s = null, z = null, A = null, v = null, y = null, C, G, H, J, E = new THREE.RenderableVertex, M = new THREE.RenderableVertex, K, F, I, L, R, $, Y, N, ea, Q, qa, la, O = new THREE.Color, fa = new THREE.Color, W = new THREE.Color, V = new THREE.Color, ia = new THREE.Color, Z = new THREE.Color, ca = new THREE.Color, Ga = {}, Pa = {}, Ia, Ua, na, Va, ib, Ra, eb, pb, Pb, db, $a = new THREE.Rectangle, Ja = new THREE.Rectangle, wa = new THREE.Rectangle, wb = !1, Da = new THREE.Color, qb = new THREE.Color, fb = new THREE.Color, ra = new THREE.Vector3, gb, Za, Wa, Ea, xb, k, a = 16;
	...
	this.clear = function () {
		...
		!1 === Ja.isEmpty() && (Ja.minSelf($a), Ja.inflate(2), 1 > t && q.clearRect(Math.floor(Ja.getX()), Math.floor(Ja.getY()), Math.floor(Ja.getWidth()), Math.floor(Ja.getHeight())), 0 < t && (c(THREE.NormalBlending), b(1), e("rgba(" + Math.floor(255 * r.r) + "," + Math.floor(255 * r.g) + "," + Math.floor(255 * r.b) + "," + t + ")"), q.fillRect(Math.floor(Ja.getX()), Math.floor(Ja.getY()), Math.floor(Ja.getWidth()), Math.floor(Ja.getHeight()))), Ja.empty())
	};
	this.render = function (a, l) {
		...
		function Ba(a, b, c, d, f, g, h, k, i, j, l, m, n) {
			if (!(n instanceof THREE.DataTexture || void 0 === n.image || 0 == n.image.width)) {
				...
				var Ba = n.offset.x / n.repeat.x, o = n.offset.y / n.repeat.y, p = n.image.width * n.repeat.x, tb = n.image.height * n.repeat.y, h = (h + Ba) * p, k = (1 - k + o) * tb, c = c - a, d = d - b, f = f - a, g = g - b, i = (i + Ba) * p - h, j = (1 - j + o) * tb - k, l = (l + Ba) * p - h, m = (1 - m + o) * tb - k, Ba = i * m - l * j;
			...
			for (Fc = h.length; B < Fc; B++)
				if (ja = h[B], aa = ja.material, !(void 0 === aa || !1 === aa.visible)) {
					...
					if (ja instanceof THREE.RenderableParticle) {
						...
						aa instanceof THREE.ParticleBasicMaterial ? null === aa.map ? (jb = Xa.object.scale.x, kb = Xa.object.scale.y, jb *= Xa.scale.x * p, kb *= Xa.scale.y * o, wa.set(z.x - jb, z.y - kb, z.x + jb, z.y + kb), !1 !== $a.intersects(wa) && (e(aa.color.getContextStyle()), q.save(), q.translate(z.x, z.y), q.rotate(-Xa.rotation), q.scale(jb, kb), q.fillRect(-1, -1, 2, 2), q.restore())) : (ja = aa.map.image, kc = ja.width >> 1, Uc = ja.height >> 1, jb = Xa.scale.x * p, kb = Xa.scale.y * o, rb = jb * kc, sb = kb * Uc, wa.set(z.x - rb, z.y - sb, z.x + rb, z.y + sb), !1 !== $a.intersects(wa) && (q.save(), q.translate(z.x, z.y), q.rotate(-Xa.rotation), q.scale(jb, -kb), q.translate(-kc, -Uc), q.drawImage(ja, 0, 0), q.restore())) : aa instanceof THREE.ParticleCanvasMaterial && (rb = Xa.scale.x * p, sb = Xa.scale.y * o, wa.set(z.x - rb, z.y - sb, z.x + rb, z.y + sb), !1 !== $a.intersects(wa) && (d(aa.color.getContextStyle()), e(aa.color.getContextStyle()), q.save(), q.translate(z.x, z.y), q.rotate(-Xa.rotation), q.scale(rb, sb), aa.program(q), q.restore()))
					} else if (ja instanceof THREE.RenderableLine) {
						if (C = ja.v1, G = ja.v2, C.positionScreen.x *= p, C.positionScreen.y *= o, G.positionScreen.x *= p, G.positionScreen.y *= o, wa.addPoint(C.positionScreen.x, C.positionScreen.y), wa.addPoint(G.positionScreen.x, G.positionScreen.y), !0 === $a.intersects(wa) && (z = C, Xa = G, b(aa.opacity), c(aa.blending), q.beginPath(), q.moveTo(z.positionScreen.x, z.positionScreen.y), q.lineTo(Xa.positionScreen.x, Xa.positionScreen.y), aa instanceof THREE.LineBasicMaterial))
...
THREE.WebGLRenderer = function (a) {
	...
	function g(a, b, c) {
		...
		if (c.sortParticles) {
			...
			for (d = 0; d < g; d++)
				e = h[d], Za.copy(e), gb.multiplyVector3(Za), m[d] = [Za.z, d];
			m.sort(function (a, b) {
				return b[0] - a[0]
			});
			for (d = 0; d < g; d++)
							...
							if (m.image instanceof Array && 6 === m.image.length) {
								if (c = m, e = j, 6 === c.image.length)
									if (c.needsUpdate) {
										...
										j = [];
										for (l = 0; 6 > l; l++)
											Q.autoScaleCubemaps && !e ? (n = j, m = l, s = c.image[l], v = Tc, s.width <= v && s.height <= v || (y = Math.max(s.width, s.height), t = Math.floor(s.width * v / y), v = Math.floor(s.height * v / y), y = document.createElement("canvas"), y.width = t, y.height = v, y.getContext("2d").drawImage(s, 0, 0, s.width, s.height, 0, 0, t, v), s = y), n[m] = s) : j[l] = c.image[l];
										l = j[0];
										...
										for (l = 0; 6 > l; l++)
											if (e) {
												...
												k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X + l, 0, m, m, s, j[l]);
	...
	var a = a || {}, M = void 0 !== a.canvas ? a.canvas : document.createElement("canvas"), K = void 0 !== a.precision ? a.precision : "highp", F = void 0 !== a.alpha ? a.alpha : !0, I = void 0 !== a.premultipliedAlpha ? a.premultipliedAlpha : !0, L = void 0 !== a.antialias ? a.antialias : !1, R = void 0 !== a.stencil ? a.stencil : !0, $ = void 0 !== a.preserveDrawingBuffer ? a.preserveDrawingBuffer : !1, Y = void 0 !== a.clearColor ? new THREE.Color(a.clearColor) : new THREE.Color(0), N = void 0 !== a.clearAlpha ? a.clearAlpha : 0, ea = void 0 !== a.maxLights ? a.maxLights : 4;
	this.domElement = M;
	this.context = null;
	...
	var Q = this, qa = [], la = 0, O = null, fa = null, W = -1, V = null, ia = null, Z = 0, ca = 0, Ga = -1, Pa = -1, Ia = -1, Ua = -1, na = -1, Va = -1, ib = -1, Ra = -1, eb = null, pb = null, Pb = null, db = null, $a = 0, Ja = 0, wa = 0, wb = 0, Da = 0, qb = 0, fb = new THREE.Frustum, ra = new THREE.Matrix4, gb = new THREE.Matrix4, Za = new THREE.Vector4, Wa = new THREE.Vector3, Ea = !0, xb = {ambient: [0, 0, 0], directional: {length: 0, colors: [], positions: []}, point: {length: 0, colors: [], positions: [], distances: []}, spot: {length: 0, colors: [], positions: [], distances: [], directions: [], angles: [], exponents: []}, hemi: {length: 0, skyColors: [], groundColors: [], positions: []}}, k, Qb, yb;
	try {
	...
	this.deallocateObject = function (a) {
		if (a.__webglInit)
			if (a.__webglInit = !1, delete a._modelViewMatrix, delete a._normalMatrix, delete a._normalMatrixArray, delete a._modelViewMatrixArray, delete a._modelMatrixArray, a instanceof THREE.Mesh)
	...
	this.renderBufferImmediate = function (a, b, c) {
		...
		if (a.hasNormals) {
			...
			if (c.shading === THREE.FlatShading) {
				...
				for (o = 0; o < p; o += 9)
					m = a.normalArray, d = m[o], e = m[o + 1], f = m[o + 2], g = m[o + 3], i = m[o + 4], l = m[o + 5], h = m[o + 6], j = m[o + 7], n = m[o + 8], d = (d + g + h) / 3, e = (e + i + j) / 3, f = (f + l + n) / 3, m[o] = d, m[o + 1] = e, m[o + 2] = f, m[o + 3] = d, m[o + 4] = e, m[o + 5] = f, m[o + 6] = d, m[o + 7] = e, m[o + 8] = f
			}
	...
	this.renderBuffer = function (a, b, c, d, e, f) {
		if (!1 !== d.visible) {
			var g, h, c = B(a, b, c, d, f), b = c.attributes, a = !1, c = 16777215 * e.id + 2 * c.id + (d.wireframe ? 1 : 0);
			c !== V && (V = c, a = !0);
			if (!d.morphTargets && 0 <= b.position)
				...
				if (f.morphTargetForcedOrder.length) {
					...
					for (g = f.morphTargetInfluences; i < d.numSupportedMorphTargets && i < h.length;)
						k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphTargetsBuffers[h[i]]), k.vertexAttribPointer(c["morphTarget" + i], 3, k.FLOAT, !1, 0, 0), d.morphNormals && (k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphNormalsBuffers[h[i]]), k.vertexAttribPointer(c["morphNormal" + i], 3, k.FLOAT, !1, 0, 0)), f.__webglMorphTargetInfluences[i] = g[h[i]], i++
				} else {
					h = [];
					...
					for (i = 0; i < d.numSupportedMorphTargets;)
						h[i] ? (l = h[i][0], k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphTargetsBuffers[l]), k.vertexAttribPointer(c["morphTarget" + i], 3, k.FLOAT, !1, 0, 0), d.morphNormals && (k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphNormalsBuffers[l]), k.vertexAttribPointer(c["morphNormal" + i], 3, k.FLOAT, !1, 0, 0)), f.__webglMorphTargetInfluences[i] = g[l]) : (k.vertexAttribPointer(c["morphTarget" + i], 3, k.FLOAT, !1, 0, 0), d.morphNormals && k.vertexAttribPointer(c["morphNormal" + i], 3, k.FLOAT, !1, 0, 0), f.__webglMorphTargetInfluences[i] = 0), i++
				}
			...
			if (a) {
				if (e.__webglCustomAttributesList) {
					...
					for (h = e.__webglCustomAttributesList.length; g < h; g++)
						c = e.__webglCustomAttributesList[g], 0 <= b[c.buffer.belongsToAttribute] && (k.bindBuffer(k.ARRAY_BUFFER, c.buffer), k.vertexAttribPointer(b[c.buffer.belongsToAttribute], c.size, k.FLOAT, !1, 0, 0))
				}
			...
			f instanceof THREE.Mesh ? (d.wireframe ? (d = d.wireframeLinewidth, d !== db && (k.lineWidth(d), db = d), a && k.bindBuffer(k.ELEMENT_ARRAY_BUFFER, e.__webglLineBuffer), k.drawElements(k.LINES, e.__webglLineCount, k.UNSIGNED_SHORT, 0)) : (a && k.bindBuffer(k.ELEMENT_ARRAY_BUFFER, e.__webglFaceBuffer), k.drawElements(k.TRIANGLES, e.__webglFaceCount, k.UNSIGNED_SHORT, 0)), Q.info.render.calls++, Q.info.render.vertices += e.__webglFaceCount, Q.info.render.faces += e.__webglFaceCount / 3) : f instanceof THREE.Line ? (f = f.type === THREE.LineStrip ? k.LINE_STRIP : k.LINES, d = d.linewidth, d !== db && (k.lineWidth(d), db = d), k.drawArrays(f, 0, e.__webglLineCount), Q.info.render.calls++) : f instanceof THREE.ParticleSystem ? (k.drawArrays(k.POINTS, 0, e.__webglParticleCount), Q.info.render.calls++, Q.info.render.points += e.__webglParticleCount) : f instanceof THREE.Ribbon && (k.drawArrays(k.TRIANGLE_STRIP, 0, e.__webglVertexCount), Q.info.render.calls++)
		}
	};
	this.render = function (a, b, c, d) {
		if (!1 === b instanceof THREE.Camera)
			...
			for (e = h.length; d < e; d++)
				if (f = h[d], g = f.object, f.render = !1, g.visible && (!(g instanceof THREE.Mesh || g instanceof THREE.ParticleSystem) || !g.frustumCulled || fb.contains(g))) {
					s(g, b);
		...
		for (; a.__objectsAdded.length;) {
			...
			if (!i.__webglActive) {
				if (i instanceof THREE.Mesh)
					...
					i instanceof THREE.Ribbon || i instanceof THREE.Line || i instanceof THREE.ParticleSystem ? (m = i.geometry, p(j.__webglObjects, m, i)) : i instanceof THREE.ImmediateRenderObject || i.immediateRenderCallback ? j.__webglObjectsImmediate.push({object: i, opaque: null, transparent: null}) : i instanceof THREE.Sprite ? j.__webglSprites.push(i) : i instanceof THREE.LensFlare && j.__webglFlares.push(i);
				i.__webglActive = !0
			}
		...
		for (var fb = 0, qb = a.__webglObjects.length; fb < qb; fb++) {
			...
			if (ub instanceof THREE.Mesh)
				if (ga instanceof THREE.BufferGeometry)
					(ga.verticesNeedUpdate || ga.elementsNeedUpdate || ga.uvsNeedUpdate || ga.normalsNeedUpdate || ga.colorsNeedUpdate || ga.tangentsNeedUpdate) && h(ga, k.DYNAMIC_DRAW, !ga.dynamic), ga.verticesNeedUpdate = !1, ga.elementsNeedUpdate = !1, ga.uvsNeedUpdate = !1, ga.normalsNeedUpdate = !1, ga.colorsNeedUpdate = !1, ga.tangentsNeedUpdate = !1;
				else {
							...
							if (ma.__inittedArrays) {
								...
								if (jd) {
									...
									for (rc = bc.length; Ma < rc; Ma++) {
										D = ha = 0;
										for (X = oa.length; D < X; D++)
											$b = oa[D], P = Ta[$b], S = bc[Ma].vertices[P.a], T = bc[Ma].vertices[P.b], U = bc[Ma].vertices[P.c], Ka = Vc[Ma], Ka[ha] = S.x, Ka[ha + 1] = S.y, Ka[ha + 2] = S.z, Ka[ha + 3] = T.x, Ka[ha + 4] = T.y, Ka[ha + 5] = T.z, Ka[ha + 6] = U.x, Ka[ha + 7] = U.y, Ka[ha + 8] = U.z, db.morphNormals && (Gc ? (Sb = Ic[Ma].vertexNormals[$b], Cb = Sb.a, Db = Sb.b, Eb = Sb.c) : Eb = Db = Cb = Ic[Ma].faceNormals[$b], La = Wc[Ma], La[ha] = Cb.x, La[ha + 1] = Cb.y, La[ha + 2] = Cb.z, La[ha + 3] = Db.x, La[ha + 4] = Db.y, La[ha + 5] = Db.z, La[ha + 6] = Eb.x, La[ha + 7] = Eb.y, La[ha + 8] = Eb.z), ha += 9;
										D = 0;
										for (X = pa.length; D < X; D++)
											$b = pa[D], P = Ta[$b], S = bc[Ma].vertices[P.a], T = bc[Ma].vertices[P.b], U = bc[Ma].vertices[P.c], ka = bc[Ma].vertices[P.d], Ka = Vc[Ma], Ka[ha] = S.x, Ka[ha + 1] = S.y, Ka[ha + 2] = S.z, Ka[ha + 3] = T.x, Ka[ha + 4] = T.y, Ka[ha + 5] = T.z, Ka[ha + 6] = U.x, Ka[ha + 7] = U.y, Ka[ha + 8] = U.z, Ka[ha + 9] = ka.x, Ka[ha + 10] = ka.y, Ka[ha + 11] = ka.z, db.morphNormals && (Gc ? (Sb = Ic[Ma].vertexNormals[$b], Cb = Sb.a, Db = Sb.b, Eb = Sb.c, tc = Sb.d) : tc = Eb = Db = Cb = Ic[Ma].faceNormals[$b], La = Wc[Ma], La[ha] = Cb.x, La[ha + 1] = Cb.y, La[ha + 2] = Cb.z, La[ha + 3] = Db.x, La[ha + 4] = Db.y, La[ha + 5] = Db.z, La[ha + 6] = Eb.x, La[ha + 7] = Eb.y, La[ha + 8] = Eb.z, La[ha + 9] = tc.x, La[ha + 10] = tc.y, La[ha + 11] = tc.z), ha += 12;
								...
								if (ac.length) {
									D = 0;
									for (X = oa.length; D < X; D++)
										P = Ta[oa[D]], Ib = ac[P.a], Jb = ac[P.b], Kb = ac[P.c], za[da] = Ib.x, za[da + 1] = Ib.y, za[da + 2] = Ib.z, za[da + 3] = Ib.w, za[da + 4] = Jb.x, za[da + 5] = Jb.y, za[da + 6] = Jb.z, za[da + 7] = Jb.w, za[da + 8] = Kb.x, za[da + 9] = Kb.y, za[da + 10] = Kb.z, za[da + 11] = Kb.w, Lb = fc[P.a], Mb = fc[P.b], Nb = fc[P.c], ya[da] = Lb.x, ya[da + 1] = Lb.y, ya[da + 2] = Lb.z, ya[da + 3] = Lb.w, ya[da + 4] = Mb.x, ya[da + 5] = Mb.y, ya[da + 6] = Mb.z, ya[da + 7] = Mb.w, ya[da + 8] = Nb.x, ya[da + 9] = Nb.y, ya[da + 10] = Nb.z, ya[da + 11] = Nb.w, da += 12;
									D = 0;
									for (X = pa.length; D < X; D++)
										P = Ta[pa[D]], Ib = ac[P.a], Jb = ac[P.b], Kb = ac[P.c], vc = ac[P.d], za[da] = Ib.x, za[da + 1] = Ib.y, za[da + 2] = Ib.z, za[da + 3] = Ib.w, za[da + 4] = Jb.x, za[da + 5] = Jb.y, za[da + 6] = Jb.z, za[da + 7] = Jb.w, za[da + 8] = Kb.x, za[da + 9] = Kb.y, za[da + 10] = Kb.z, za[da + 11] = Kb.w, za[da + 12] = vc.x, za[da + 13] = vc.y, za[da + 14] = vc.z, za[da + 15] = vc.w, Lb = fc[P.a], Mb = fc[P.b], Nb = fc[P.c], wc = fc[P.d], ya[da] = Lb.x, ya[da + 1] = Lb.y, ya[da + 2] = Lb.z, ya[da + 3] = Lb.w, ya[da + 4] = Mb.x, ya[da + 5] = Mb.y, ya[da + 6] = Mb.z, ya[da + 7] = Mb.w, ya[da + 8] = Nb.x, ya[da + 9] = Nb.y, ya[da + 10] = Nb.z, ya[da + 11] = Nb.w, ya[da + 12] = wc.x, ya[da + 13] = wc.y, ya[da + 14] = wc.z, ya[da + 15] = wc.w, da += 16;
								...
								if (id && Pb) {
									D = 0;
									for (X = oa.length; D < X; D++)
										P = Ta[oa[D]], vb = P.vertexColors, Hc = P.color, 3 === vb.length && Pb === THREE.VertexColors ? (Fb = vb[0], Gb = vb[1], Hb = vb[2]) : Hb = Gb = Fb = Hc, Oa[Fa] = Fb.r, Oa[Fa + 1] = Fb.g, Oa[Fa + 2] = Fb.b, Oa[Fa + 3] = Gb.r, Oa[Fa + 4] = Gb.g, Oa[Fa + 5] = Gb.b, Oa[Fa + 6] = Hb.r, Oa[Fa + 7] = Hb.g, Oa[Fa + 8] = Hb.b, Fa += 9;
									D = 0;
									for (X = pa.length; D < X; D++)
										P = Ta[pa[D]], vb = P.vertexColors, Hc = P.color, 4 === vb.length && Pb === THREE.VertexColors ? (Fb = vb[0], Gb = vb[1], Hb = vb[2], uc = vb[3]) : uc = Hb = Gb = Fb = Hc, Oa[Fa] = Fb.r, Oa[Fa + 1] = Fb.g, Oa[Fa + 2] = Fb.b, Oa[Fa + 3] = Gb.r, Oa[Fa + 4] = Gb.g, Oa[Fa + 5] = Gb.b, Oa[Fa + 6] = Hb.r, Oa[Fa + 7] = Hb.g, Oa[Fa + 8] = Hb.b, Oa[Fa + 9] = uc.r, Oa[Fa + 10] = uc.g, Oa[Fa + 11] = uc.b, Fa += 12;
								...
								if (Tc && bb.hasTangents) {
									...
									D = 0;
									for (X = pa.length; D < X; D++)
										P = Ta[pa[D]], Rb = P.vertexTangents, zb = Rb[0], Ab = Rb[1], Bb = Rb[2], sc = Rb[3], xa[ua] = zb.x, xa[ua + 1] = zb.y, xa[ua + 2] = zb.z, xa[ua + 3] = zb.w, xa[ua + 4] = Ab.x, xa[ua + 5] = Ab.y, xa[ua + 6] = Ab.z, xa[ua + 7] = Ab.w, xa[ua + 8] = Bb.x, xa[ua + 9] = Bb.y, xa[ua + 10] = Bb.z, xa[ua + 11] = Bb.w, xa[ua + 12] = sc.x, xa[ua + 13] = sc.y, xa[ua + 14] = sc.z, xa[ua + 15] = sc.w, ua += 16;
								...
								if (bd && Zc && hc) {
									...
									for (X = pa.length; D < X; D++)
										if (Xb = pa[D], nc = Zc[Xb], void 0 !== nc)
											for (sa = 0; 4 > sa; sa++)
												pc = nc[sa], yc[Ub] = pc.u, yc[Ub + 1] = pc.v, Ub += 2;
									0 < Ub && (k.bindBuffer(k.ARRAY_BUFFER, ma.__webglUV2Buffer), k.bufferData(k.ARRAY_BUFFER, yc, mb))
								}
								if (Ec) {
									D = 0;
									for (X = oa.length; D < X; D++)
										...
										if (w = Xc[sa], w.__original.needsUpdate) {
											...
											if (1 === w.size)
												if (void 0 === w.boundTo || "vertices" === w.boundTo) {
													...
													D = 0;
													for (X = pa.length; D < X; D++)
														P = Ta[pa[D]], w.array[x] = w.value[P.a], w.array[x + 1] = w.value[P.b], w.array[x + 2] = w.value[P.c], w.array[x + 3] = w.value[P.d], x += 4
												} else {
													if ("faces" === w.boundTo) {
														D = 0;
														for (X = oa.length; D < X; D++)
												...
												if (void 0 === w.boundTo || "vertices" === w.boundTo) {
													D = 0;
													for (X = oa.length; D < X; D++)
														P = Ta[oa[D]], S = w.value[P.a], T = w.value[P.b], U = w.value[P.c], w.array[x] = S.x, w.array[x + 1] = S.y, w.array[x + 2] = T.x, w.array[x + 3] = T.y, w.array[x + 4] = U.x, w.array[x + 5] = U.y, x += 6;
													D = 0;
													for (X = pa.length; D < X; D++)
													...
													if ("faces" === w.boundTo) {
														...
														D = 0;
														for (X = pa.length; D < X; D++)
															ka = U = T = S = ta = w.value[pa[D]], w.array[x] = S.x, w.array[x + 1] = S.y, w.array[x + 2] = T.x, w.array[x + 3] = T.y, w.array[x + 4] = U.x, w.array[x + 5] = U.y, w.array[x + 6] = ka.x, w.array[x + 7] = ka.y, x += 8
													}
												}
											else if (3 === w.size) {
												var ba;
												...
												if (void 0 === w.boundTo || "vertices" === w.boundTo) {
													D = 0;
													for (X = oa.length; D < X; D++)
														P = Ta[oa[D]], S = w.value[P.a], T = w.value[P.b], U = w.value[P.c], w.array[x] = S[ba[0]], w.array[x + 1] = S[ba[1]], w.array[x + 2] = S[ba[2]], w.array[x + 3] = T[ba[0]], w.array[x + 4] = T[ba[1]], w.array[x + 5] = T[ba[2]], w.array[x + 6] = U[ba[0]], w.array[x + 7] = U[ba[1]], w.array[x + 8] = U[ba[2]], x += 9;
													D = 0;
													for (X = pa.length; D < X; D++)
													...
													D = 0;
													for (X = oa.length; D < X; D++)
														U = T = S = ta = w.value[oa[D]], w.array[x] = S[ba[0]], w.array[x + 1] = S[ba[1]], w.array[x + 2] = S[ba[2]], w.array[x + 3] = T[ba[0]], w.array[x + 4] = T[ba[1]], w.array[x + 5] = T[ba[2]], w.array[x + 6] = U[ba[0]], w.array[x + 7] = U[ba[1]], w.array[x + 8] = U[ba[2]], x += 9;
													D = 0;
													for (X = pa.length; D < X; D++)
														ka = U = T = S = ta = w.value[pa[D]], w.array[x] = S[ba[0]], w.array[x + 1] = S[ba[1]], w.array[x + 2] = S[ba[2]], w.array[x + 3] = T[ba[0]], w.array[x + 4] = T[ba[1]], w.array[x + 5] = T[ba[2]], w.array[x + 6] = U[ba[0]], w.array[x + 7] = U[ba[1]], w.array[x + 8] = U[ba[2]], w.array[x + 9] = ka[ba[0]], w.array[x + 10] = ka[ba[1]], w.array[x + 11] = ka[ba[2]], x += 12
													...
													D = 0;
													for (X = pa.length; D < X; D++)
														ta = w.value[pa[D]], S = ta[0], T = ta[1], U = ta[2], ka = ta[3], w.array[x] = S[ba[0]], w.array[x + 1] = S[ba[1]], w.array[x + 2] = S[ba[2]], w.array[x + 3] = T[ba[0]], w.array[x + 4] = T[ba[1]], w.array[x + 5] = T[ba[2]], w.array[x + 6] = U[ba[0]], w.array[x + 7] = U[ba[1]], w.array[x + 8] = U[ba[2]], w.array[x + 9] = ka[ba[0]], w.array[x + 10] = ka[ba[1]], w.array[x + 11] = ka[ba[2]], x += 12
												}
											} else if (4 === w.size)
												if (void 0 === w.boundTo || "vertices" === w.boundTo) {
													D = 0;
													for (X = oa.length; D < X; D++)
														P = Ta[oa[D]], S = w.value[P.a], T = w.value[P.b], U = w.value[P.c], w.array[x] = S.x, w.array[x + 1] = S.y, w.array[x + 2] = S.z, w.array[x + 3] = S.w, w.array[x + 4] = T.x, w.array[x + 5] = T.y, w.array[x + 6] = T.z, w.array[x + 7] = T.w, w.array[x + 8] = U.x, w.array[x + 9] = U.y, w.array[x + 10] = U.z, w.array[x + 11] = U.w, x += 12;
													D = 0;
													for (X = pa.length; D < X; D++)
													...
													D = 0;
													for (X = oa.length; D < X; D++)
														U = T = S = ta = w.value[oa[D]], w.array[x] = S.x, w.array[x + 1] = S.y, w.array[x + 2] = S.z, w.array[x + 3] = S.w, w.array[x + 4] = T.x, w.array[x + 5] = T.y, w.array[x + 6] = T.z, w.array[x + 7] = T.w, w.array[x + 8] = U.x, w.array[x + 9] = U.y, w.array[x + 10] = U.z, w.array[x + 11] = U.w, x += 12;
													D = 0;
													for (X = pa.length; D < X; D++)
														ka = U = T = S = ta = w.value[pa[D]], w.array[x] = S.x, w.array[x + 1] = S.y, w.array[x + 2] = S.z, w.array[x + 3] = S.w, w.array[x + 4] = T.x, w.array[x + 5] = T.y, w.array[x + 6] = T.z, w.array[x + 7] = T.w, w.array[x + 8] = U.x, w.array[x + 9] = U.y, w.array[x + 10] = U.z, w.array[x + 11] = U.w, w.array[x + 12] = ka.x, w.array[x + 13] = ka.y, w.array[x + 14] = ka.z, w.array[x + 15] = ka.w, x += 16
												} else if ("faceVertices" === w.boundTo) {
													D = 0;
													for (X = oa.length; D < X; D++)
													...
													D = 0;
													for (X = pa.length; D < X; D++)
														ta = w.value[pa[D]], S = ta[0], T = ta[1], U = ta[2], ka = ta[3], w.array[x] = S.x, w.array[x + 1] = S.y, w.array[x + 2] = S.z, w.array[x + 3] = S.w, w.array[x + 4] = T.x, w.array[x + 5] = T.y, w.array[x + 6] = T.z, w.array[x + 7] = T.w, w.array[x + 8] = U.x, w.array[x + 9] = U.y, w.array[x + 10] = U.z, w.array[x + 11] = U.w, w.array[x + 12] = ka.x, w.array[x + 13] = ka.y, w.array[x + 14] = ka.z, w.array[x + 15] = ka.w, x += 16
												}
											k.bindBuffer(k.ARRAY_BUFFER, w.buffer);
											k.bufferData(k.ARRAY_BUFFER, w.array, mb)
										}
								}
								yb && (delete ma.__inittedArrays, delete ma.__colorArray, delete ma.__normalArray, delete ma.__tangentArray, delete ma.__uvArray, delete ma.__uv2Array, delete ma.__faceArray, delete ma.__vertexArray, delete ma.__lineArray, delete ma.__skinIndexArray, delete ma.__skinWeightArray)
							}
						}
				...
				if (ga.verticesNeedUpdate || ga.colorsNeedUpdate) {
					var cc = ga, cd = k.DYNAMIC_DRAW, zc = void 0, Ac = void 0, Jc = void 0, dc = void 0, Kc = void 0, dd = cc.vertices, ed = cc.colors, kd = dd.length, ld = ed.length, Lc = cc.__vertexArray, Mc = cc.__colorArray, md = cc.colorsNeedUpdate;
						...
						for (hd = ad.length; Rc < hd; Rc++)
							if (va = ad[Rc], va.needsUpdate && (void 0 === va.boundTo || "vertices" === va.boundTo)) {
								...
								if (1 === va.size)
									...
									for (Qa = 0; Qa < qc; Qa++)
										cb = va.value[Qa], va.array[Aa] = cb.x, va.array[Aa + 1] = cb.y, Aa += 2;
								else if (3 === va.size)
									if ("c" === va.type)
										for (Qa = 0; Qa < qc; Qa++)
	...
	this.initMaterial = function (a, b, c, d) {
		...
		a:{
			...
			b = a.attributes;
			p = a.defines;
			var c = {map: !!a.map, envMap: !!a.envMap, lightMap: !!a.lightMap, bumpMap: !!a.bumpMap, normalMap: !!a.normalMap, specularMap: !!a.specularMap, vertexColors: a.vertexColors, fog: c, useFog: a.fog, sizeAttenuation: a.sizeAttenuation, skinning: a.skinning, maxBones: l, useVertexTexture: ic && d && d.useVertexTexture, boneTextureWidth: d && d.boneTextureWidth, boneTextureHeight: d && d.boneTextureHeight, morphTargets: a.morphTargets, morphNormals: a.morphNormals, maxMorphTargets: this.maxMorphTargets, maxMorphNormals: this.maxMorphNormals, maxDirLights: e, maxPointLights: f, maxSpotLights: g, maxHemiLights: h, maxShadows: m, shadowMapEnabled: this.shadowMapEnabled && d.receiveShadow, shadowMapSoft: this.shadowMapSoft, shadowMapDebug: this.shadowMapDebug, shadowMapCascade: this.shadowMapCascade, alphaTest: a.alphaTest, metal: a.metal, perPixel: a.perPixel, wrapAround: a.wrapAround, doubleSided: a.side === THREE.DoubleSide, flipSided: a.side === THREE.BackSide}, t, u, v, d = [];
	...
	this.setRenderTarget = function (a) {
		...
		if (a && !a.__webglFramebuffer) {
			...
			if (b) {
				...
				a.__webglFramebuffer = k.createFramebuffer(), a.__webglRenderbuffer = k.createRenderbuffer(), k.bindTexture(k.TEXTURE_2D, a.__webglTexture), G(k.TEXTURE_2D, a, c), k.texImage2D(k.TEXTURE_2D, 0, d, a.width, a.height, 0, d, e, null), d = k.TEXTURE_2D, k.bindFramebuffer(k.FRAMEBUFFER, a.__webglFramebuffer), k.framebufferTexture2D(k.FRAMEBUFFER, k.COLOR_ATTACHMENT0, d, a.__webglTexture, 0), H(a.__webglRenderbuffer, a), c && k.generateMipmap(k.TEXTURE_2D);
...
THREE.GeometryUtils = {merge: function (a, b) {
	...
	for (o = j.length; p < o; p++) {
		var g = j[p], r, t, B = g.vertexNormals, u = g.vertexColors;
		...
		void 0 !== g.materialIndex && (h = f.materials[g.materialIndex], q = h.id, u = n[q], void 0 === u && (u = a.materials.length, n[q] = u, a.materials.push(h)), r.materialIndex = u);
	...
	for (e = 0; e < h; e++)
		d = f[e], d instanceof THREE.Face3 ? (l = g[d.a], m = g[d.b], n = g[d.c], d._area = THREE.GeometryUtils.triangleArea(l, m, n)) : d instanceof THREE.Face4 && (l = g[d.a], m = g[d.b], n = g[d.c], p = g[d.d], d._area1 = THREE.GeometryUtils.triangleArea(l, m, p), d._area2 = THREE.GeometryUtils.triangleArea(m, n, p), d._area = d._area1 + d._area2), i += d._area, j[e] = i;
	d = [];
	for (e = 0; e < b; e++)
...
THREE.ImageUtils = {crossOrigin: "anonymous", loadTexture: function (a, b, c, d) {
	...
	for (i = 0; i < d.mipmapCount; i++) {
		var j = Math.max(4, f) / 4 * Math.max(4, g) / 4 * e, l = {data: new Uint8Array(a, h, j), width: f, height: g};
		d.mipmaps.push(l);
		h += j;
		f = Math.max(0.5 * f, 1);
		g = Math.max(0.5 * g, 1)
	...
	for (var h = g.getImageData(0, 0, d, e).data, i = g.createImageData(d, e), j = i.data, l = 0; l < d; l++)
		for (var m = 0; m < e; m++) {
			var n = 0 > m - 1 ? 0 : m - 1, p = m + 1 > e - 1 ? e - 1 : m + 1, o = 0 > l - 1 ? 0 : l - 1, q = l + 1 > d - 1 ? d - 1 : l + 1, r = [], t = [0, 0, h[4 * (m * d + l)] / 255 * b];
...
(function (a) {
	...
	a.Triangulate = function (a, d) {
		...
		for (j = e - 1; e > 2;) {
			...
			a:{
				n = a;
				var p = i, o = j, q = l, r = e, t = g, B = void 0, u = void 0, s = void 0, z = void 0, A = void 0, v = void 0, y = void 0, C = void 0, G = void 0, u = n[t[p]].x, s = n[t[p]].y, z = n[t[o]].x, A = n[t[o]].y, v = n[t[q]].x, y = n[t[q]].y;
...
THREE.ExtrudeGeometry.WorldUVGenerator = {generateTopUV: function (a, b, c, d, e, f) {
	...
	var b = a.vertices[e].x, c = a.vertices[e].y, e = a.vertices[e].z, d = a.vertices[f].x, i = a.vertices[f].y, f = a.vertices[f].z, j = a.vertices[g].x, l = a.vertices[g].y, g = a.vertices[g].z, m = a.vertices[h].x, n = a.vertices[h].y, a = a.vertices[h].z;
...
THREE.ShadowMapPlugin = function () {
	...
	this.init = function (g) {
		...
		e = new THREE.ShaderMaterial({fragmentShader: g.fragmentShader, vertexShader: g.vertexShader, uniforms: h, skinning: true});
		...
		for (p = z.length; n < p; n++) {
			...
			for (q = s.length; o < q; o++) {
				...
				if (B.render) {
					...
					B instanceof THREE.BufferGeometry ? b.renderBufferDirect(r, l.__lights, null, u, B, t) : b.renderBuffer(r, l.__lights, null, u, B, t)
				}
			}
